...
class BaseAdminLteView extends BaseView
{
    ...
    public function openModal(string $baseid = "default", string $title = "", array $params = [])
    {
        ...
        return
            ...
            . '		<div class="modal-dialog ' . (($p["scrollable"]) ? ' modal-dialog-scrollable ' : '') . $p["modal-dialog-styles"] . ' ' . $p["modal-dialog-css"] . '" role="document">'
            . '			<div class="modal-content '. $p["modal-content-css"] .'">'
            . '				<div class="modal-header '. $p["modal-header-css"] .'">'
