class e {
    ...
    constructor(a, b, c = this._onDecodeError.bind(this), d = e.DEFAULT_CANVAS_SIZE, f = "environment") {
        this.$video = a;
        this.$canvas = document.createElement("canvas");
        this._onDecode = b;
        this._preferredFacingMode = f;
        this._flashOn = this._paused = this._active = !1;
        "number" === typeof c ? (d = c, console.warn("You're using a deprecated version of the QrScanner constructor which will be removed in the future")) :
    ...
    pause() {
        this._paused = !0;
        this._active && (this.$video.pause(), this._offTimeout || (this._offTimeout =
            setTimeout(() => {
    ...
    static scanImage(a, b = null, c = null, d = null, f = !1, k = !1) {
        let g = c instanceof Worker,
            h = Promise.all([c || e.createQrEngine(), e._loadImage(a)]).then(([a, h]) => {
                c = a;
                let k;
                [d, k] = this._drawToCanvas(h, b, d, f);
                return c instanceof Worker ? (g || c.postMessage({
                    type: "inversionMode",
                    data: "both"
                }), new Promise((a, b) => {
                    let f, l, g;
    ...
    _updateSourceRect() {
        ...
        this._sourceRect.x = (this.$video.videoWidth -
            a) / 2;
    ...
    _scanFrame() {
        ...
        requestAnimationFrame(() => {
            1 >= this.$video.readyState ? this._scanFrame() : this._qrEnginePromise.then(a => e.scanImage(this.$video, this._sourceRect, a, this.$canvas, !0)).then(this._onDecode, a => {
