...
(function (d, a) {
    ...
    class d {
        ...
        constructor(a, b, c = this._onDecodeError.bind(this), e = d.DEFAULT_CANVAS_SIZE, g = "environment") {
            this.$video = a;
            this.$canvas = document.createElement("canvas");
            this._onDecode = b;
            this._preferredFacingMode = g;
            this._flashOn = this._paused = this._active = !1;
            "number" === typeof c ? (e = c, console.warn("You're using a deprecated version of the QrScanner constructor which will be removed in the future")) : this._onDecodeError = c;
            this.$canvas.width = e;
        ...
        destroy() {
            ...
            this.stop();
            d._postWorkerMessage(this._qrEnginePromise,
                "close")
        }
        start() {
        ...
        static scanImage(a, b = null,
            c = null, e = null, g = !1, k = !1) {
            let f = c instanceof Worker,
                h = Promise.all([c || d.createQrEngine(), d._loadImage(a)]).then(([a, h]) => {
                    c = a;
                    let k;
                    [e, k] = this._drawToCanvas(h, b, e, g);
                    return c instanceof Worker ? (f || c.postMessage({
                        type: "inversionMode",
                        data: "both"
                    }), new Promise((a, b) => {
                        let g, l, f;
                        l = e => {
                            "qrResult" === e.data.type && (c.removeEventListener("message", l), c.removeEventListener("error", f), clearTimeout(g), null !== e.data.data ? a(e.data.data) : b(d.NO_QR_CODE_FOUND))
                        };
                        f = a => {
                            c.removeEventListener("message", l);
                            c.removeEventListener("error",
                                f);
                            clearTimeout(g);
            ...
            b && k &&
                (h = h.catch(() => d.scanImage(a, null, c, e, g)));
            return h = h.finally(() => {
                f || d._postWorkerMessage(c, "close")
            })
        }
        ...
        _getMatchingCameraStream(a) {
            return navigator.mediaDevices &&
                0 !== a.length ? navigator.mediaDevices.getUserMedia({
                    video: a.shift()
        ...
        static _drawToCanvas(a, b = null, c = null, e = !1) {
            ...
            let d = b && b.x ? b.x : 0,
                k = b && b.y ? b.y : 0,
                f = b && b.width ? b.width : a.width || a.videoWidth;
            b = b && b.height ? b.height : a.height || a.videoHeight;
            e || c.width === f && c.height === b || (c.width = f, c.height = b);
            e = c.getContext("2d", {
                alpha: !1
            });
            e.imageSmoothingEnabled = !1;
            e.drawImage(a, d, k, f, b, 0, 0, c.width, c.height);
            return [c, e]
        }
        static _loadImage(a) {
    ...
    d.WORKER_PATH = "../js/qr-scanner-worker.min.js";
    return d
})
